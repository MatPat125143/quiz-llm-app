# Generated by Django 4.2.7 on 2025-12-11 14:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('knowledge_level', models.CharField(choices=[('elementary', 'Szkoła podstawowa'), ('high_school', 'Liceum'), ('university', 'Studia'), ('expert', 'Ekspert')], default='high_school', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('knowledge_level', models.CharField(blank=True, choices=[('elementary', 'Szkoła podstawowa'), ('high_school', 'Liceum'), ('university', 'Studia'), ('expert', 'Ekspert')], max_length=20, null=True)),
                ...
                ('session', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='quiz_app.quizsession')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='answers', to='quiz_app.quizsession')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question_sessions', to='quiz_app.question')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='session_questions', to='quiz_app.quizsession')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='answer',
            constraint=models.UniqueConstraint(fields=('question', 'user', 'session'), name='unique_answer_per_question_session'),
        ),
    ]
