    ...
    operations = [
            ...
            fields=[
                ...
                ('default_knowledge_level', models.CharField(
                    choices=[('elementary', 'Szkoła podstawowa'), ('high_school', 'Liceum'), ('university', 'Studia'),
                             ('expert', 'Ekspert')], default='high_school',
                    help_text='Domyślny poziom wiedzy używany przy tworzeniu quizów', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='password_reset_tokens',
                                   to=settings.AUTH_USER_MODEL)),
            ],
            options={
